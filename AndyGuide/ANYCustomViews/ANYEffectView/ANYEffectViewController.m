...
@interface ANYEffectViewController ()

@end

@implementation ANYEffectViewController
...
- (void)viewDidLoad {
    ...
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake((kWIDTH*0.5)-(BG_IMAGE_WIDTH*0.5), BG_VIEW_Y + 20.0f, BG_IMAGE_WIDTH, BG_IMAGE_HEIGHT)];
    bgView.alpha = 0.5;
    ...
    lable.text = @"我是胡巴";
    lable.textColor = [ANYColor colorWithHexString:@"#333333"];
